              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomDrawerTile(tileName: 'Generate Ticket', tileIcon: Image.asset(changepasswordIconR,color: primaryColor, scale: 1.3,),onTap: (){Get.to(GenerateTicket());},),
                   CustomDrawerTile(tileName: 'My Wallet', tileIcon: Image.asset(termsandconditionIconR,color: primaryColor, scale: 1.3,), onTap: (){Get.to(SubscriptionPage());},),
                  CustomDrawerTile(tileName: 'Support', tileIcon: Image.asset(shareappIconR,color: primaryColor, scale: 1.3,),onTap: (){Get.to(share());},),
                  CustomDrawerTile(tileName: 'Feedback', tileIcon: Image.asset(privactpolicyIconR,color: primaryColor, scale: 1.3,), onTap: (){Get.to(PrivacyPolicyScreen());},),
                  CustomDrawerTile(tileName: 'parcel Stetus', tileIcon: Image.asset(privactpolicyIconR,color: primaryColor, scale: 1.3,), onTap: (){Get.to(ParcelStetus());},),
                  ...
                  CustomDrawerTile(tileName: 'Contact Us', tileIcon: Image.asset(contactusIconR,color: primaryColor, scale: 1.3,), onTap: (){Get.to(ContactUsScreen());},),
...
// import '../Provider/getsetingprovider.dart';
