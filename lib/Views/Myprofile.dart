...
//   //                   }
//   //                 },
//   //                 icon: Icon(Icons.edit_calendar_sharp,color: colors.secondary,)
//   //             ) : Container()
//   //           ],
//   //         ),
//   //       ));
...
//
//         _getDrawerItem(getTranslated(context, 'CHANGE_STATE')!,
//             'assets/images/pro_language.svg'),
//         //  CUR_USERID == "" || CUR_USERID == null ? Container() : _getDivider(),
//         CUR_USERID == "" || CUR_USERID == null
//             ? Container()
...
//         title,
//         style: TextStyle(
//             color:Theme.of(context).colorScheme.darkMode, fontSize: 15),
//       ),
//       onTap: () {
...
//                 ),
//               ));
//         } else if (title == getTranslated(context, 'CHANGE_STATE')) {
//           openStateChangeBottomSheet();
//           // Navigator.push(
//           //     context,
//           //     MaterialPageRoute(
//           //       builder: (context) => ChangeState(
//           //         //title: getTranslated(context, 'CHANGE_STATE'),
//           //       ),
//           //     ));
...
//                   child: Text("Profile",style: TextStyle(color: colors.whiteTemp,fontSize: 20,fontWeight: FontWeight.bold),),
//                 ),
//               ),
//             ),
//             // Container(
...
//             //                     child: Text("Profile",style: TextStyle(color: colors.secondary,fontSize: 20),),
//             //                   )),
//             //             )
//             //         ),
//             //       ),
...
//   }
//
//   void openStateChangeBottomSheet() {
//     showModalBottomSheet(
//         shape: const RoundedRectangleBorder(
//             borderRadius: BorderRadius.only(
...
//                       ),
//                       child: Center(child: Text("Ok",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.w600),)),
//                     ),
//                   )
//                 ],
//               ),
